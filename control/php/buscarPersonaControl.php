...
if ($criterio==""){
	...
	if($criterio=="todos"){
	$query ="SELECT id, nombre1, nombre2, apellido1, apellido2, apellidoc, nombreu, telefono, celular, correo, modificacion FROM Boletas ORDER BY modificacion DESC";
	}
	...
	<?php	while ($row = mysql_fetch_array($result)){	
			echo "<tr>
				...
				<td class='text-center'><i style='cursor:pointer;font-size:18px;' class='fa fa-eye' id='load_personas_control' name='{$row['id']}'></i></td>
			</tr>";
		}
	?> </tbody>
	</table>	
